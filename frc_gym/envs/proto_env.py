...
class ProtoEnv(gym.Env):
	...
	def step(self, action):
		...
		self.time += self.times[self.actionToName[self.currentSate]][self.actionToName[action]]
		self.currentSate = action
		action = self.actionToName[action]
