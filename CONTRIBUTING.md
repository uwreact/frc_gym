...
The [issue tracker](https://github.com/uwreact/frc_gym/issues) is our preferred method for reporting bugs and suggesting features. We ask that you:
...
```bash
git clone https://github.com/<your-username>/frc_gym.git
```

3. Configure your remotes:

```bash
git remote add upstream https://github.com/uwreact/frc_gym.git
```
